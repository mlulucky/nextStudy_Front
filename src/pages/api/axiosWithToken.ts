...
const requestToken = (token: string): requestTokenType => {
  // 유저 인증 토큰
  return {
...
// todo api
export function toDoHttpRequest(token: string): AxiosInstance {
  // AxiosInstance : axios 인스턴스 생성 -> 요청에 원하는 값들을 설정할 수 있다.
